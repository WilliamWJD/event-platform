    ...
    return (
        <div className="flex-1">
            <div className="bg-black flex justify-center">
                <div className="h-full w-full max-w-[1100px] max-h-[60hv] aspect-video"></div>
            </div>
                ...
                <div className="flex items-start gap-16">
                    <div className="flex-1">
                        ...
                        <div className="flex items-center gap-4 mt-6">
                            <img src="https://github.com/williamwjd.png" alt="" className="h-16 w-16 rounded-full border-2 border-blue-500" />
                            <div className="leading-relaxed">
                                <strong className="font-bold text-2xl block">William Dias</strong>
                                <span className="text-gray-200 text-sm block">Desenvolvedor Java na Confitec</span>
                            </div>
                        </div>
                    </div>
